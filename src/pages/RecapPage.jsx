...
import { lookupPlayer, generateYearRecap } from '../services/api'
...
export default function RecapPage() {
  ...
  const loadRecap = async () => {
    try {
      ...
      // Generate recap
      const recap = await generateYearRecap(player.puuid, 100)
      setRecapData(recap)
    } catch (err) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300">Generating your recap...</p>
        ...
        {recapData && (
          <>
            ...
            <div className="mt-8 text-center">
              <Link
                to={`/analysis/${region}/${gameName}/${tagLine}`}
